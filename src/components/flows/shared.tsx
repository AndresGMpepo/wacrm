...
> = {
  ...
  send_message: {
    ...
    icon: MessageCircle,
    color: 'text-sky-400',
    blurb: 'Envía un mensaje de texto por WhatsApp',
    category: 'messaging',
  },
  send_buttons: {
  ...
  send_list: {
    ...
    blurb: 'Envía una lista seleccionable de opciones',
    category: 'messaging',
  },
  send_media: {
  ...
  condition: {
    ...
    blurb: 'Divide el flujo según una regla',
    category: 'logic',
  },
  set_tag: {
  ...
  handoff: {
    ...
    blurb: 'Entrega la conversación a una persona',
    category: 'flow',
  },
  end: {
    label: 'Fin',
