...
export function Softphone() {
  ...
  const submitTransfer = () => {
    ...
    t.transfer(number, transfer === 'attended');
    setNumber('');
    setTransfer(null);
  };
