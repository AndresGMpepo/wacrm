...
export async function GET(request: Request) {
  try {
    ...
    let requestQuery = db.from('yeastar_call_transcriptions')
      .select('id, call_id, cdr_id, contact_id, customer_phone, customer_name, customer_email, agent_user_id, agent_extension, direction, started_at, answered_at, ended_at, duration_seconds, recording_url, transcript, summary, key_points, action_items, language, transcription_status, error_message, yeastar_payload, created_at, updated_at')
