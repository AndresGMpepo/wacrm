...
// replied — and the transition guard now live in
// src/lib/whatsapp/recipient-status-ladder.ts so the Zernio webhook
// handler can share the exact same rules for broadcast_recipients.
